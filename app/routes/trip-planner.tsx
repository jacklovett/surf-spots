...
export const meta: MetaFunction = () => {
  return [
    { title: 'Surf Spots - Trip Planner' },
    {
      name: 'description',
      content:
        'Trip Planner - Coming soon. Get personalized surf destination recommendations based on your surfed spots and watch list.',
    },
  ]
}
  ...
  return (
    <Page showHeader>
      <div className="center column h-full">
        <div className="info-page-content center column">
          <Icon iconKey="ai" useAccentColor />
          <h1 className="mb">Trip Planner - Coming Soon</h1>

          <div className="column gap mb center-horizontal">
            <p className="mb">
            ...
            <section>
              ...
              <ul className="benefits-list mb">
                ...
                <li>
                  Learns from your surf history to suggest similar or
                  complementary destinations
                </li>
                <li>
                  Chat with the AI to get personalized recommendations for where
                  to surf next
                </li>
                <li>
                  Receive trip planning suggestions based on your past
                  experiences
                </li>
                <li>
                  Discover new spots that match your surfing style and
                  preferences
                </li>
              </ul>
              <p className="mb">
                The more spots you add to your surfed spots and watch list, the
                better the AI can understand your preferences and provide
          ...
          {!isLoggedIn && (
            <div className="center column mt">
              <p className="mb bold">
                Stay notified when Trip Planner is ready!
              </p>
              ...
              <div className="center-horizontal mb">
                <Button
          ...
          {isLoggedIn && (
            <div className="center column mt">
              ...
              <p className="font-small">
                We'll notify you as soon as Trip Planner is ready. Stay
                tuned!
              </p>
